#!/usr/bin/env python3
"""
Integration script to combine all calibrated parameters into the main parameter dictionary.
"""
...
def integrate_calibrated_parameters():
    """
    Integrate all calibrated parameters from individual session/context files
    into the main parameter dictionary.
    """
    print("=== Integrating Calibrated Parameters ===")
    
    # Load configuration to get all sessions/contexts
    ...
    for session in sessions:
        ...
        for context in contexts:
            ...
            if context not in calibrated_param_dict[session]:
            ...
            if os.path.exists(calibration_file):
                try:
                    ...
                    calibrated_param_dict[session][context] = calibrated_jobs
                    ...
                    calibration_stats['failed_contexts'].append(f"{session}/{context}")
            else:
